...
\NormalTok{path.to.data }\OtherTok{\textless{}{-}}\NormalTok{ fs}\SpecialCharTok{::}\FunctionTok{path}\NormalTok{( }
...
\NormalTok{  path.to.data,}
  \AttributeTok{pattern =} \StringTok{".rds$"}\NormalTok{,            }\CommentTok{\# Just include .rds files.}
  \AttributeTok{full.names =} \ConstantTok{TRUE}\NormalTok{,            }\CommentTok{\# Build paths to files, not just filenames.}
  \AttributeTok{recursive =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}         \CommentTok{\# Read any subdirectories}
\NormalTok{   purrr}\SpecialCharTok{::}\FunctionTok{map\_df}\NormalTok{(readRDS) }\SpecialCharTok{\%\textgreater{}\%}   \CommentTok{\# Make a dataframe rather than a list.}
   \FunctionTok{rbind}\NormalTok{()                      }\CommentTok{\# Stack all the files found}
\end{Highlighting}
\end{Shaded}
\end{frame}
